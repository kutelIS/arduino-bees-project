...
def Ganyklos():
    ...
    data = str(linecache.getline("opcijos.csv", 1))
...
def pridettti():
    ...
    name_label = tk.Label(root, text='Pavadinimas',
    ...
    passw_label = tk.Label(root, text='Avilių skaičius',
                           font=('calibre', 10, 'normal'))
